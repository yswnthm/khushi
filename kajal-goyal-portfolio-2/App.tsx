        ...
        <div className="flex flex-col space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 px-4 md:px-0">
            <div className="mt-0 md:mt-12">
              <Reveal delay={100}>
                <WorkCard src="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=1887&auto=format&fit=crop" alt="Skincare Minimal" />
                <p className="mt-4 font-serif text-center md:text-left text-lg text-slate-blue/70">Morning Rituals</p>
              </Reveal>
            </div>
            <div className="mt-0">
               <Reveal delay={300}>
                <WorkCard src="https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?q=80&w=1887&auto=format&fit=crop" alt="Lifestyle Soft" />
                <p className="mt-4 font-serif text-center md:text-left text-lg text-slate-blue/70">Daily Essentials</p>
              </Reveal>
            </div>
            <div className="mt-0 md:mt-12">
               <Reveal delay={500}>
                <WorkCard src="https://images.unsplash.com/photo-1586799017684-25e29783777d?q=80&w=1887&auto=format&fit=crop" alt="Fashion Detail" />
      ...
      <SectionWrapper id="work-videos" pageNumber="04">
         <div className="flex flex-col space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 px-8 md:px-0">
            <Reveal delay={100}>
              <VideoCard src="https://images.unsplash.com/photo-1571781565036-d3f7595ca314?q=80&w=1888&auto=format&fit=crop" caption="Morning Routine" />
            </Reveal>
            <Reveal delay={300}>
              <VideoCard src="https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=1932&auto=format&fit=crop" caption="Aesthetics" />
            </Reveal>
            <Reveal delay={500}>
              <VideoCard src="https://images.unsplash.com/photo-1552693673-1bf958298935?q=80&w=1887&auto=format&fit=crop" caption="GRWM Style" />
            </Reveal>
          </div>
        </div>
      </SectionWrapper>
